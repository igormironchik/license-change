...
public:
              ...
              const QString &details)
    {
        ...
        ui.details->hide();
        showHide = ui.buttonBox->addButton(InfoDialog::tr("Show Details..."), QDialogButtonBox::ActionRole);
        InfoDialog::connect(showHide, &QPushButton::clicked, [this]() {
...
InfoDialog::InfoDialog(const QString &title,
                       const QString &msg,
                       const QString &details,
                       QWidget *parent)
    : QDialog(parent)
