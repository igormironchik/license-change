...
public:
    ...
    bool setSourceIndexCheckedState(QModelIndex sourceIndex,
                                    bool checked);
    bool setCheckedState(QModelIndex proxyIndex,
                         bool checked);
...
private:
    ...
    struct NodeState {
        ...
        NodeState(TreeCheckState stateForNode,
                  TreeCheckState stateForChildren)
            : nodeState(stateForNode)
...
private:
    ...
    bool setCheckState(QModelIndex sourceIndex,
                       Qt::CheckState state);
...
public:
    ...
    CheckableProxyModelState(CheckableProxyModel *proxy)
        : m_proxy(proxy)
    {
    }
